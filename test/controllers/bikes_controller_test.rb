...
class BikesControllerTest < ActionController::TestCase
  ...
  test "should create bike" do
    assert_difference('Bike.count') do
      post :create, bike: { description: @bike.description, gears: @bike.gears, profile_id: @bike.profile_id }
    end
  ...
  test "should update bike" do
    patch :update, id: @bike, bike: { description: @bike.description, gears: @bike.gears, profile_id: @bike.profile_id }
    assert_redirected_to bike_path(assigns(:bike))
  end
